...
import { useState } from "react";
  ...
  const Basket = (props) => {
    ...
    const { onClickClose, products , removeProduct, totalPrice, addShop, shopProductsLength} = props;
                ...
                <div className={styles.cartWrapper}>
                    {products.map((item) => (
                        <div className={styles.cartItem} key={item.id}>
                            ...
                            <button className={styles.buttonClose}    onClick={() => removeProduct(item.id)}>
